...
const Series = /*#__PURE__*/memo(({
  ...
  */
  ...
  useEffect(() => {
    ...
    return () => {
      if (series && series.remove) {
        ...
        } catch {// Series may have already been removed, i.e. when Axis unmounted
        }
  ...
  useEffect(() => {
    ...
    let doRedraw = false; // Using setData is more performant than update
